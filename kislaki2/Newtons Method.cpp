...
double f1(double x1, double x2) { return 2 * pow(x1, 3) - pow(x2, 2) - 1; }
double f1dx1(double x1, double x2) { return 6*pow(x1, 2); }
double f1dx2(double x1, double x2) { return -2*x2; }
double f2(double x1, double x2) { return x1*pow(x2,3)-x2-4; }
double f2dx1(double x1, double x2) { return pow(x2,3); }
double f2dx2(double x1, double x2) { return 3*x1*pow(x2,2)-1; }
